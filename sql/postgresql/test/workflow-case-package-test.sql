...
create function utassert__eq(varchar,integer,integer) returns integer as $sql$
declare
        v_msg   alias for $1;
        v_in    alias for $2;
        v_chk   alias for $3;
...
create function utassert__eq(varchar,text,text) returns integer as $sql$
declare
        v_msg   alias for $1;
        v_in    alias for $2;
        v_chk   alias for $3;
...
create function teardown() returns integer as $sql$
begin
...
create function setup() returns integer as $sql$
declare
	wf_count integer;
        exists_p boolean;
begin
...
create function run() returns integer as $sql$
declare
