...
set reassign_p [permission::permission_p -party_id $party_id -object_id $package_id -privilege "admin"]

if {!$reassign_p} {
    ad_return_complaint 1 "<li>Non sei autorizzato a riassegnare questo task."
    return
}
